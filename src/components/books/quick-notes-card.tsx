...
import { Book, Loader2, Plus, PenLine } from "lucide-react"
...
export function QuickNotesCard({ bookId, thoughts }: QuickNotesCardProps) {
    ...
    const handleAddNote = async () => {
        ...
        try {
            await addDuringReadingThought(bookId, {
                content: newNote,
                page_number: undefined, // "Quick notes" might not have page numbers implicitly
            })
            setNewNote("")
            setIsAdding(false)
